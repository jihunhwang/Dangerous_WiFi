...
if __name__ == "__main__":
    ...
    file_id_2 = '1Mq-Nlz3lIc6CEZLSxVL-YlPEpWdr8V9O' # Sam the Minuteman
    file_id_3 = '17wTBk-vfa7_fB4Mm3e3m_9RDnNiY9u5q' # Mona Lisa
    file_id_4 = '1GLVkeszoXCH7HbE0cuEvjnVMfCAa8P1L' # A screenshot of Moodle
    ...
    # Scan all files within the same directory.
    it = os.scandir(path=cwd)
    for entry in it:
        # count = count + 1
        encode_string = ''
        new_path = ''
        if not entry.name.startswith('.') and entry.is_file():
            ...
            # MS Word Files
                ...
                with open(cwd + '/' + entry_name, 'rb') as f:
                    encode_string = f.read()
                # encode_string = textract.process(cwd + '/' + entry_name, extension='docx')
                new_path = cwd + '/' + str(count) + '.png'
